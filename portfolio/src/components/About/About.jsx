...
class About extends Component {
  constructor(props) {
    ...
    this.state = {
      componentOpacity: 0,
      techList: ['Node', 'Express', 'PostgreSQL', 'Javascript', 'jQuery', 'GIT', 'HTML5', 'CSS']
    }
  }
        ...
        <div className="about-container">
          <div className="main">
            ...
            <div className="content" style={this.fade(.15)}>
              I'm a web developer based in NYC. I have experience building full-stack web applications, and
